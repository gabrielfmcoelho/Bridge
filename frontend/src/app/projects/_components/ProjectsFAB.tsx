...
export default function ProjectsFAB({ canEdit, hasProjects, activeFilterCount, onAdd, onFilter, onExport }: ProjectsFABProps) {
  const actions: FABAction[] = [
    ...(canEdit
      ? [{ label: "Add Project", icon: "M12 4v16m8-8H4", color: "#f59e0b", onClick: onAdd }]
      : []),
    {
