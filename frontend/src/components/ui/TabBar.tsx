    ...
    >
      {tabs.map((tab) => (
        <button
          ...
          className={`flex-1 md:flex-none flex items-center justify-center gap-1.5 px-3 md:px-4 py-1.5 text-xs md:text-sm font-medium rounded-[var(--radius-sm)] transition duration-150 whitespace-nowrap active:scale-[0.97] ${
            activeTab === tab.key
