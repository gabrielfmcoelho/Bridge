    ...
    >
      ...
      <div
        className="relative w-9 h-5 bg-[var(--bg-overlay)] rounded-full
                   peer-checked:bg-[var(--accent)] peer-focus-visible:ring-2 peer-focus-visible:ring-[var(--accent)]/40 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-[var(--bg-surface)]
                   transition-colors
