...
export default function LineageLegend() {
  ...
  return (
    <div className="pointer-events-auto bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] text-xs shadow-[var(--shadow-md)]">
      <button
        onClick={() => setOpen(o => !o)}
        className="px-2.5 py-1.5 text-2xs text-[var(--text-muted)] hover:text-[var(--text-primary)] flex items-center gap-1"
      >
      ...
      {open && (
        <div className="px-3 pb-2 space-y-2 max-w-[260px]">
          <div>
            <div className="text-3xs text-[var(--text-faint)] mb-1">{t("atlas.lineage.cards.nodes")}</div>
          ...
          <div>
            <div className="text-3xs text-[var(--text-faint)] mb-1">{t("atlas.lineage.cards.edges")}</div>
          ...
          <div>
            <div className="text-3xs text-[var(--text-faint)] mb-1">{t("atlas.lineage.legend.markers")}</div>
